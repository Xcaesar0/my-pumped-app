/*
  ...
  1. New Tables
    ...
    - `user_task_submissions` - Track user submissions for admin tasks
  ...
  3. Performance
    ...
    - Add default tasks for the platform
*/
...
-- Insert some default admin tasks (use INSERT ... ON CONFLICT with a specific constraint)
DO $$
BEGIN
